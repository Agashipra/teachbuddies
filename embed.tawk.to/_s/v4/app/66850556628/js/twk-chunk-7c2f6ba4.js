    ...
    ["chunk-7c2f6ba4"], {
        ...
        "9b79": function(n, t, e) {
            ...
            var r = new RegExp("```([\\s\\S]*?)```", "g"),
                o = new RegExp("(`)(.*?)\\1", "g"),
                u = new RegExp("(?<!_)\\[([^\\]]*)\\]\\(([^\\s]+)(?:\\s+&quot;(.*?)&quot;)?\\)", "g"),
                c = new RegExp("_\\[([^\\[\\]]*)\\]\\(([^)\\s]+)(?:\\s+&quot;(.*?)&quot;)?\\)", "g"),
                a = new RegExp("\\*{1,2}(\\S.*?\\S)\\*{1,2}", "g"),
                i = new RegExp("(?<!\\w)_{1,2}(\\S.*?\\S)_{1,2}(?!\\w)", "g"),
                ...
                return t = (t = (t = function(n) {
                        ...
                        for (n.trim().split("\n").forEach((function(n) {
                                ...
                                if (o) {
                                    for (var u = function(n) {
                                        ...
                                        }(n) - 1; e > u;) t.push("</ol>"), r.pop(), e--;
                                    e < u ? (t.push("<ol><li>".concat(o[2], "</li>")), r.push(u), e++) : t.push("<li>".concat(o[2], "</li>"))
                                }
                            })); e > 0;) t.push("</ol>"), e--;
                    ...
                    return n.replace(s, (function(n) {
                        ...
                        for (n.trim().split("\n").forEach((function(n) {
                                var r = n.match(/^(\s*)(-|\+)(?!-|\+)(.*)/);
                                if (r) {
                                    for (var o = r[1].length, u = r[3].trim(); e > o;) t.push("</ul>"), e--;
                                    e < o ? (t.push("<ul><li>".concat(u, "</li>")), e++) : t.push("<li>".concat(u, "</li>"))
                                }
                            })); e > 0;) t.push("</ul>"), e--;
                    ...
                    return n.replace(p, (function(n, t, e) {
                        ...
                        return o.push(e), o.push("</blockquote>".repeat(r)), "\n" + o.join("")
                    }))
                }(t = function(n) {
                    return n.replace(l, (function(n, t) {
                        var e, r, o = "",
                            u = "",
                            c = (null === (e = n.match(/^~+/)) || void 0 === e ? void 0 : e[0].length) || 0,
                            a = (null === (r = n.match(/~+$/)) || void 0 === r ? void 0 : r[0].length) || 0;
                        return c !== a && (c >= 2 || a >= 2) && (c > 2 && a > 2 ? (o = "~".repeat(c - 2), u = "~".repeat(a - 2)) : (o = "~".repeat(c - 1), u = "~".repeat(a - 1))), o + "<del>" + t + "</del>" + u
                    }))
                }(t = function(n) {
                    ...
                    return n.replace(i, (function(n, t) {
                        var e, r, o = "",
                            u = "",
                            c = (null === (e = n.match(/^_+/)) || void 0 === e ? void 0 : e[0].length) || 0,
                            a = (null === (r = n.match(/_+$/)) || void 0 === r ? void 0 : r[0].length) || 0;
                        return c !== a && (c >= 2 || a >= 2) && (c > 2 && a > 2 ? (o = "_".repeat(c - 2), u = "_".repeat(a - 2)) : (o = "_".repeat(c - 1), u = "_".repeat(a - 1))), o + "<i>" + t + "</i>" + u
                    }))
                }(t = function(n) {
                    return n.replace(a, (function(n, t) {
                        var e, r, o = "",
                            ...
                            c = (null === (e = n.match(/^\*+/)) || void 0 === e ? void 0 : e[0].length) || 0,
                            a = (null === (r = n.match(/\*+$/)) || void 0 === r ? void 0 : r[0].length) || 0;
                        return c !== a && (c >= 2 || a >= 2) && (c > 2 && a > 2 ? (o = "*".repeat(c - 2), u = "*".repeat(a - 2)) : (o = "*".repeat(c - 1), u = "*".repeat(a - 1))), o + "<strong>" + t + "</strong>" + u
                    }))
                }(t = (t = t.replace(/```([\s\S]*?)```/g, (function(n) {
                    return r.push(n), "CODEBLOCK_PLACEHOLDER_".concat((r.length - 1).toString())
                }))).replace(/`([^`]+)`/g, (function(n) {
                    return e.push(n), "INLINECODE_PLACEHOLDER_".concat((e.length - 1).toString())
                }))))))))))).replace(/INLINECODE_PLACEHOLDER_(\d+)/g, (function(n, t) {
                    return function(n) {
                        return n.replace(o, (function(n, t, e) {
                            return "<code>" + e + "</code>"
                        }))
                    }(e[Number(t)])
                }))).replace(/CODEBLOCK_PLACEHOLDER_(\d+)/g, (function(n, t) {
                    return h(r[Number(t)])
                }))
            }
