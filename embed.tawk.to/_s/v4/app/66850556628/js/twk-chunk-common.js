    ...
    ["chunk-common"], {
                ...
                var w = function(t, e, n) {
                        ...
                        for (var e = this, n = [], i = {}, r = null, s = !1, c = !1, u = function() {
                                ...
                                g.attchs && Array.isArray(g.attchs) && g.attchs.forEach((function(t) {
                                    ...
                                    if ("suggested-messages" === n) {
                                        c = !0;
                                        var i = "",
                                            o = h.match(e.regSurveyQuestion);
                                        o && o.length && (i = o.replace(e.regOption, "")), r = {
                                            question: i,
                                            options: t.content.options
                                        }
                                    } else "file" === n ? b = e.processFile(g) : "ticket-form" === n && (s = !0)
                                })), h = e.parseText(o.a.rawEncode(o.a.rawDecode(g.m))), !c && h && (r = e.parseSurvey(g.m)), n.push(f(f({}, b), {}, {
                                    timeStamp: y,
                                    message: h || "",
                                    name: p,
                                    type: g.t,
                    ...
                    value: function(e, n) {
                        ...
                        if (e.attchs && Array.isArray(e.attchs) && e.attchs.forEach((function(t) {
                                ...
                                } else "file" === n ? p = l.processFile(e) : "ticket-form" === n && (g = !0, w = t.content.ref)
                            ...
                            c || (c = this.parseText(e.m), v || e.attchs || (m = this.parseSurvey(e.m)))
                        }
                        ...
                        actions: {
                            ...
                            setPageStatus: function(e, n) {
                                var o = e.state,
                                    ...
                                    c = n.data,
                                    u = n.status;
                                if (!s["schedule/isEnabled"] && void 0 !== s["widget/agentDrivenStatus"] && !1 === s["widget/agentDrivenStatus"]) return a("triggerPageStatusAPI", "online"), void r("updatePageStatus", "online");
                ...
                var s = function(t, e, n) {
                    ...
                    value: function(t, e) {
                        ...
                        this.version ? o.sv = this.version : o.sv = void 0 !== r ? r : null, i.a.get("".concat("https://va.tawk.to", "/v1/widget-settings"), o, null, (function(i, o) {
                            ...
                            }, n.languageScript.async = !0, n.languageScript.charset = "UTF-8", n.languageScript.src = "".concat("https://embed.tawk.to/_s/v4/app/66850556628", "/languages/").concat(o.data.widget.language, ".js")
                        }))
                    }
                }, {
                    key: "processSettings",
            ...
            (function(t) {
                ...
                var E = function(t, e, n) {
                    ...
                    value: function(e) {
                        ...
                        })), !k.a.getters["session/needConsent"] && e && t.Tawk_Window.app.$socket.connect(), t.Tawk_Window.activityMonitor.initActivityReset(), !k.a.getters["browserData/mobileBrowserName"] && t.Tawk_Window.maximize && k.a.commit("session/setChatWindowState", "max"), t.Tawk_Window.jsApi.setVisitorAttributes()
                    }
                }])
            }).call(this, n("c8ba"))
        },
                ...
                var d = function(t, e, n) {
                    ...
                    value: function() {
                        var e = c(a().mark((function e() {
                            var n, i, s, c, u, l, d, f, h, p, m, w, g, v;
                            return a().wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        if (c = void 0, t.Tawk_Window) {
                                            e.next = 3;
                                            break
                                        }
                                        return e.abrupt("return");
                                    case 3:
                                        if (u = "", l = this.store.getters, (d = t.Tawk_Window.sessionManager.getSessionInformation()).length && (u = d[0]), ((f = (new Date).getTimezoneOffset()) < -900 || f > 900) && (f = 0), !window.sessionStorage.getItem("tawk_has_register_visitor") && null !== (n = window.Tawk_API) && void 0 !== n && n.visitor && "object" === r(window.Tawk_API.visitor) && null !== (i = window.Tawk_API) && void 0 !== i && null !== (i = i.visitor) && void 0 !== i && i.userId && null !== (s = window.Tawk_API) && void 0 !== s && null !== (s = s.visitor) && void 0 !== s && s.hash && (c = o.a.formatVisitorLoginData(window.Tawk_API.visitor)), this.registerData ? this.registerData.vss = u : this.registerData = {
                                                p: l["property/id"] || "",
                                                w: l["widget/id"],
                                                platform: l["browserData/mobileBrowserName"] ? "mobile" : "desktop",
                                                tzo: f,
                                                url: document.location.href,
                                                referrer: document.referrer || void 0,
                                                vss: u,
                                                user: c
                                            }, h = null, window.location && window.location.href) try {
                                            "http:" !== (h = new URL(window.location.href)).protocol && "https:" !== h.protocol && "file:" !== h.protocol || (this.registerData.url = window.location.href)
                                        } catch (t) {}
                                        if (!h && window.top !== window) try {
                                        ...
                                        this.registerData.consent = !1, p = 0;
                                    case 17:
                                        if (!(p < d.length)) {
                                            e.next = 24;
                                            break
                                        ...
                                        return this.registerData.consent = !0, e.abrupt("break", 24);
                                    case 21:
                                        p++, e.next = 17;
                                        break;
                                    case 24:
                                        return t.Tawk_Window.maximize ? this.registerData.wss = "max" : this.registerData.wss = "min", e.prev = 25, e.next = 28, t.Tawk_Window.sessionManager.getUUID();
                                    case 28:
                                        if (m = e.sent, w = m.uuid, g = m.version, v = m.isPartial, !w) {
                                            e.next = 38;
                                            break
                                        }
                                        this.registerData.u = w, this.registerData.uv = parseInt(g, 10), 2 === g && v && (this.registerData.uw = 1), e.next = 41;
                                        break;
                                    case 38:
                                        return e.next = 40, t.Tawk_Window.sessionManager.getIdempotencyKey();
                                    case 40:
                                    ...
                                    case 41:
                                        ...
                                        break;
                                    case 43:
                                        e.prev = 43, e.t0 = e.catch(25), console.error(e.t0);
                                    case 46:
                                    case "end":
                                        return e.stop()
                                }
                    ...
                    value: function(e, n) {
                        ...
                        c && (a = {
                            "X-Tawk-Token": c
                        }), this.previousRegisterCall = i.a.post(s, this.registerData, a, (function(t, i) {
                            var a;
                            return o.clearTimers(), t || !t && !i ? o.retryRegister(e, n) : i.error ? i.error.code && "InternalServerError" === i.error.code ? o.retryRegister(e, n) : n() : (null !== (a = window.Tawk_API) && void 0 !== a && a.visitor && "object" === r(window.Tawk_API.visitor) && window.sessionStorage.setItem("tawk_has_register_visitor", !0), void e(i))
                        }), !0, !0)
                    }
                }, {
        ...
        c7b8: function(t, e, n) {
            ...
            var u = function(t, e, n) {
                ...
                key: "reportError",
                value: function(t) {
                    i.a.post("".concat("https://va.tawk.to", "/log"), function(t) {
                        for (var e = 1; e < arguments.length; e++) {
                            var n = null != arguments[e] ? arguments[e] : {};
