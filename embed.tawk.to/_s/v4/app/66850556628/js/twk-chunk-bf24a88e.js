                ...
                e.a = n.a.component("i-frame", {
                    ...
                    methods: {
                        renderChildren: function() {
                            ...
                            l.href = this.cssLink, l.rel = "stylesheet", c.href = "https://fonts.googleapis.com/css?family=Lato:100,100i,300,300i,400,400i,700,700i,900,900i&subset=latin-ext", r.appendChild(s), r.classList.add("font-lato");
                            var h = "1rem",
                                m = "0";
                            if (this.$store.getters["widget/isRTL"] && r.classList.add("tawk-rtl"), this.$store.getters["browserData/mobileBrowserName"]) {
                                ...
                                p && p.mobile && p.mobile.maximized && (p.mobile.maximized.paddingTop && (h = "".concat(p.mobile.maximized.paddingTop, "px")), p.mobile.maximized.paddingBottom && (m = "".concat(p.mobile.maximized.paddingBottom, "px")))
                            }
                            ...
                            u["http-equiv"] = "Content-Type", u.content = "text/html; charset=utf-8";
                            var w = document.createElement("meta");
                            w.name = "viewport", w.content = "width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no", i.appendChild(u), i.appendChild(w);
                            var b = document.createElement("style");
                            b.type = "text/css", b.classList.add("tawk-global-variables");
